...
namespace AplicatieSalariati.Controllers
{
    ...
    public class AngajatController : Controller
    {
        ...
        {
            DateAngajatModel dateAngajatModel = new DateAngajatModel();
            string nume = User.Identity.GetUserName().Substring(1);
            var dateAngajatModelList = db.DateAngajatModels.Where
                (a => a.Nume.Contains(nume)).ToList();
            dateAngajatModel = dateAngajatModelList.First();
            if (dateAngajatModel == null)
            {
                return HttpNotFound();
            }
            concediiModel.CNP = dateAngajatModel.CNP;
        ...
        public ActionResult VizConcedii()
        {
            ...
            var concediiModellist = db.ConcediiModels.Where(a => a.CNP.Contains(dateAngajatModel.CNP));
        ...
        public ActionResult Fluturasi()
        {
            ...
            SalarizareModel salarizareModel = db.SalarizareModels.Find(dateAngajatModel.CNP);
        ...
        public ActionResult Details(string id)
        {
            ...
            {
                dateAngajatModel = db.DateAngajatModels.Find(id);
                if (dateAngajatModel == null)
                {
                    return HttpNotFound();
                }
