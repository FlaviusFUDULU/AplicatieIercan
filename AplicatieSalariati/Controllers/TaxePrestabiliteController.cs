...
namespace AplicatieSalariati.Controllers
{
    public class TaxePrestabiliteController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Impozit,CAS,CASS,CAM")] TaxePrestabiliteModel taxePrestabiliteModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Impozit,CAS,CASS,CAM")] TaxePrestabiliteModel taxePrestabiliteModel)
        {
            if (ModelState.IsValid)
            {
